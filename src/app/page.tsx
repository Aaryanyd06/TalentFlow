...
const Card: FC<{
    ...
    <div className="bg-white dark:bg-gray-800 rounded-lg p-4 shadow-sm border border-gray-200 dark:border-gray-700 transition-transform duration-300 hover:-translate-y-1">
        <div className="flex items-center gap-3">
            <Image src={avatar} alt={name} className="w-10 h-10 rounded-full" width={40} height={40} unoptimized={true} />
            <div>
...
export default function LandingPage() {
    ...
    return (
        <>
            ...
            <main className="bg-white dark:bg-black text-gray-800 dark:text-gray-200">
                <section className="relative isolate overflow-hidden min-h-screen flex flex-col justify-center px-6 pt-8 lg:px-8 hero-section">
  <Image
    src="/image_bg.jpg"      
    alt="Background"
    fill                     
  ...
  <div className="absolute inset-0 bg-white/0 dark:bg-black/20 z-10"></div>


  <div className="relative z-20 mx-auto max-w-2xl py-16 sm:py-20 lg:py-24 text-center">
    <AnimatedComponent>
                                    ...
                                    <AnimatedComponent key={index} delay={index * 100}>
                                        <div className="break-inside-avoid-column rounded-xl bg-gray-100 dark:bg-gray-800/60 p-6 h-full shadow-sm">
                                            ...
                                            <div className="mt-4 flex items-center gap-3">
                                                {/* FIX: Added unoptimized={true} for external SVG */}
                                                <Image
